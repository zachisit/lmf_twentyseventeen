...
<main>
    ...
    <div id="home_two_cta">
        <div id="one">
            <div id="left">
                <img src="<? echo get_template_directory_uri(); ?>/images/home_two_cta_one_left.jpg" alt="<? echo get_bloginfo( 'name' ); ?> - Home" />
            </div>
            <div id="right">
        ...
        <div id="two">
            <div id="left">
                <img src="<? echo get_template_directory_uri(); ?>/images/home_two_cta_two_left.jpg" alt="<? echo get_bloginfo( 'name' ); ?> - Home" />
            </div>
            <div id="right">
                <h2>New Releases</h2>
    ...
    <div id="home_intouch">
        <div id="left">
            ...
            <div class="datum"><a href="tel:+15045861094">504-586-1094</a></div>
            <div class="title">our address:</div>
            <div class="datum">Louisana Music Factory<br />421 Frenchmens St.<br />New Orleans, LA 70116</div>
            <div class="title">contact us</div>
            <div class="datum">Click <a href="" title="">here</a> to contact us</div>
            <div class="title">twitter</div>
            <div class="datum"><a href="" title="">@LMFnola</a></div>
        </div>
        <div id="right">
