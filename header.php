...
<header>
    <div id="logo">
        <a href="<? echo get_home_url(); ?>" title="Home"><img src="<? echo get_template_directory_uri(); ?>/images/logo.png" alt="<? echo get_bloginfo( 'name' ); ?> - Home" /></a>
    </div>
    <div id="right">
        <div id="top">
            <div id="one">
            ...
            <div id="three">
                <div id="contact"><a href="" title="Contact <? echo get_bloginfo( 'name' ); ?>">Contact Us</a></div>
            </div>
            <div id="four">
                <div id="login"><a href="" title="<? echo get_bloginfo( 'name' ); ?> Customer Login">Customer Login</a></div>
            </div>
        </div>
        <div id="bottom">
            <div id="menu">
